...
public class Pagination implements Serializable {
	...
	private int rowsPerPage = 10; // 每页行数，默认10
	private int currentPage; // 当前页数
	private int pageListSize = 5;// 页码列表大小，默认5
	...
	public static void main(String[] args) {
		Pagination pagination = new Pagination(1183);
		System.out.println(pagination.getPageListSize());
		System.out.println(pagination.getStart());
		System.out.println(pagination.getEnd());

		pagination.lastPage();
		System.out.println(pagination.getPageNumList());
		System.out.println(pagination.getStart()+"..."+pagination.getEnd());
		
		pagination.doPagination(5);
		System.out.println(pagination.getPageNumList());
		System.out.println(pagination.getStart()+"..."+pagination.getEnd());
